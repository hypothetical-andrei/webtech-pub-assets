...
function BookList () {
  ...
  useEffect(() => {
    dispatch(getBooks(filterString, page, 2))
  }, [filterString, page])
  ...
  return (
    <div>
      <DataTable
        ...
        totalRecords={count}
      >
        <Column header='Title' field='title' filter filterField='title' filterPlaceholder='filter by title' onFilterApplyClick={handleFilter} onFilterClear={handleFilterClear} />
